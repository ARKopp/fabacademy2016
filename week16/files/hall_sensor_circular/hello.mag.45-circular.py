...
def idle(parent,canvas):
   ...
   canvas.coords('zeiger', MIDDLE, MIDDLE, MIDDLE-(math.sin(value*math.pi)*MIDDLE), MIDDLE+(math.cos(value*math.pi)*MIDDLE))
   canvas.update()
...
canvas.create_line(MIDDLE, MIDDLE , MIDDLE, 0, tags='zeiger', fill='#0000b0')
canvas.pack()
